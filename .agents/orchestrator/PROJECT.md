...
| 11| Breed Encyclopedia & Filtering | Breed list with multi-criteria search/filter (Energy, Prey Drive, Sensitivity, Excitement Threshold) | M4 | R3 |
...
| M3 | Live GPS Walk Tracking & 1-Tap Trigger Log | Dual map engine (Google Maps + Leaflet fallback), live route polyline, 1-tap trigger logging drawer, intensity map markers | M2 | PLANNED |
